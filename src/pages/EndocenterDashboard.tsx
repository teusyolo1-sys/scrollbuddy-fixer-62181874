...
function DashboardContent() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 w-full z-30 border-b border-white/5" style={{ background: 'hsl(228 18% 14% / 0.95)', backdropFilter: 'blur(40px) saturate(150%)', WebkitBackdropFilter: 'blur(40px) saturate(150%)' }}>
            ...
            {tabs.map((tab) => {
              ...
              return (
                <motion.button
                  ...
                  className="group relative flex items-center gap-1.5 px-4 py-2 whitespace-nowrap text-xs sm:text-sm font-medium"
                  style={{
                ...
                >
                  <motion.span
                    ...
                    whileHover={{ rotate: tab.id === "workflow" ? 180 : tab.id === "deadlines" ? [0, -12, 12, -8, 0] : [-12, 0], scale: 1.2 }}
                    transition={{ type: "spring", stiffness: 400, damping: 14 }}
                  >

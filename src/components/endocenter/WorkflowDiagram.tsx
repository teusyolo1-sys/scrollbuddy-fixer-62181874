const steps = [
  {
    number: "01", title: "Planejamento Estratégico", owner: "Estrategista", icon: "🧠", color: "#059669", colorLight: "#ECFDF5",
    duration: "Dia 25 do mês anterior",
  ...
  {
    number: "02", title: "Produção de Copy", owner: "Copywriter", icon: "✍️", color: "#7C3AED", colorLight: "#F5F3FF",
    duration: "48h após receber briefing",
    inputs: ["Briefing detalhado da estrategista", "Histórico de copies de alta performance", "Tom de voz da Endocenter", "Objetivos da campanha (leads, awareness)"],
    outputs: ["Textos de anúncios (Meta + Google)", "Legendas de posts e stories", "Scripts de vídeo", "Mensagens de WhatsApp"],
    rules: ["Copy enviada para revisão da estrategista antes de ir para o designer", "Copys de anúncios entregues até 3ª-feira de cada semana", "Máximo 2 rodadas de revisão por copy — na 3ª, copywriter reescreve do zero"],
  },
  {
    number: "03", title: "Criação Visual", owner: "Designer", icon: "🎨", color: "#DC2626", colorLight: "#FFF1F2",
    duration: "48-72h após aprovação da copy",
    inputs: ["Copy aprovada pela estrategista", "Briefing de design da estrategista", "Guia de marca Endocenter", "Referências visuais aprovadas"],
    outputs: ["Artes para feed e stories", "Criativos de anúncios", "Banners e materiais especiais", "Carrosséis e reels"],
    rules: ["Designer não inicia criação sem copy aprovada (evita retrabalho)", "Arte enviada para o gestor de tráfego só após aprovação visual da estrategista", "Ajustes solicitados pela estrategista: prazo máximo de 24h para correção"],
  },
  {
    number: "04", title: "Aprovação Final", owner: "Estrategista", icon: "✅", color: "#0D9488", colorLight: "#F0FDFA",
    duration: "24h após receber peças",
    ...
    rules: ["Aprovação deve ser registrada por escrito no canal oficial da equipe", "Prazo de resposta: até 24h após recebimento das peças", "Se não houver resposta em 24h, o responsável deve fazer follow-up"],
  },
  {
    number: "05", title: "Publicação & Tráfego", owner: "Gestor de Tráfego", icon: "📡", color: "#1E6FD9", colorLight: "#EFF6FF",
    duration: "Conforme calendário editorial",
    inputs: ["Criativos aprovados pela estrategista", "Configurações de campanha", "Orçamento definido", "Públicos-alvo configurados"],
    outputs: ["Campanhas ativas (Meta + Google)", "Posts publicados no feed", "Relatório semanal de performance", "Alertas de anomalias"],
    rules: ["Nenhum anúncio entra no ar sem aprovação prévia da estrategista", "Otimizações de campanha: diariamente (no mínimo segunda, quarta e sexta)", "Qualquer anomalia (CPL > 2x a meta, campanha zerada) deve ser reportada em até 2h"],
  },
  {
    number: "06", title: "Análise & Feedback Loop", owner: "Estrategista + Gestor", icon: "🔄", color: "#EA580C", colorLight: "#FFF7ED",
    duration: "Sexta-feira de cada semana",
    ...
    rules: ["Relatório semanal do gestor: toda sexta até 18h", "Reunião semanal de alinhamento: 30 minutos, sempre na segunda-feira", "Resultados abaixo da meta por 2 semanas consecutivas: acionar plano de crise"],
  },
];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
          ...
          {steps.map((step, i) => (
            <div key={i} className="flex items-center gap-2">
              <div className="flex flex-col items-center gap-1">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center text-xl" style={{ backgroundColor: step.colorLight }}>
                  {step.icon}
                </div>
        ...
        <div className="flex gap-4 mt-4 text-[10px] text-slate-400 justify-center">
          <span>⚡ SLA máximo: 48-72h por etapa</span>
          <span>✅ Aprovação documentada obrigatória</span>
          <span>🚫 Etapas não podem ser puladas</span>
        </div>
      </div>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="bg-slate-50 rounded-xl p-4">
                  <div className="flex items-center gap-1.5 mb-2">
                    ...
                    <span className="text-[10px] font-bold text-slate-400 tracking-wider">ENTRADAS</span>
                  </div>
                ...
                <div className="rounded-xl p-4" style={{ backgroundColor: step.colorLight }}>
                  <div className="flex items-center gap-1.5 mb-2">
                    <span className="text-sm">📤</span>
                    <span className="text-[10px] font-bold tracking-wider" style={{ color: step.color }}>SAÍDAS / ENTREGÁVEIS</span>
                  </div>
                ...
                <div className="bg-amber-50 rounded-xl p-4 border border-amber-100">
                  <div className="flex items-center gap-1.5 mb-2">
                    <span className="text-sm">📋</span>
                    <span className="text-[10px] font-bold text-amber-600 tracking-wider">REGRAS DA ETAPA</span>
                  </div>

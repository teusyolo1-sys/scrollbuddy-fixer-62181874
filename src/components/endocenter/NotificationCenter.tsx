      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-12 w-80 sm:w-96 rounded-2xl border border-white/20 dark:border-white/10 overflow-hidden z-[100] shadow-2xl"
            style={{ background: 'hsl(var(--card) / 0.99)', backdropFilter: 'blur(24px) saturate(140%)', WebkitBackdropFilter: 'blur(24px) saturate(140%)' }}
          >
            {/* Header */}

...
const team = [
  ...
  },
  {
    ...
    kpis: ["Briefing entregue até dia 25/mês", "Aprovação em < 24h", "Meta mensal de leads"],
    status: "Ativo",
  },
];
...
const metrics = [
  { label: "Investimento Mensal Equipe", value: `R$ ${totalRemuneration.toLocaleString("pt-BR")}`, sub: "Folha + Freelancers", icon: "💰", color: "#1E6FD9" },
  { label: "Horas Totais / Mês", value: `${totalHours}h`, sub: "Capacidade operacional", icon: "⏱️", color: "#7C3AED" },
  { label: "Custo Médio / Hora", value: `R$ ${(totalRemuneration / totalHours).toFixed(2).replace(".", ",")}`, sub: "Eficiência da equipe", icon: "📈", color: "#059669" },
  { label: "Profissionais Ativos", value: "4", sub: "Todos operacionais", icon: "👥", color: "#DC2626" },
];
